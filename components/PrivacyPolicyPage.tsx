  ...
  return (
    <section className="container-shell py-16">
      <Reveal className="max-w-3xl">
        <p className="mb-4 text-sm font-black uppercase tracking-[0.22em] text-teal-200">{t.privacy.eyebrow}</p>
        <h1 className="text-balance text-5xl font-black tracking-tight text-white sm:text-6xl">{t.privacy.title}</h1>
        <p className="mt-6 text-lg leading-8 text-slate-300">{t.privacy.intro}</p>
      </Reveal>
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[320px_1fr] lg:items-start">
        ...
        <article className="rounded-[2rem] border border-white/10 bg-slate-50 p-6 text-slate-900 shadow-2xl shadow-black/20 sm:p-10">
